...
| **UX (July 2026)** | Persistent AI disclaimer; loading/error trust copy; progressive disclosure; mobile Support CTA; cultural review checklist |
...
Aether hosts production and experimental skills (skill authoring, NZ AI safety, grants, trajectory capture, composition, agent performance/routing, Te Mana Raraunga controls, etc.).

**System of record for alignment evidence:** [Aether `docs/alignments/`](https://github.com/fivepanelhat/Aether/tree/main/docs/alignments).

---

## Packaging intent (no public $)

Commercial packaging is documented for segments and GTM sequence without public dollar prices. See portfolio `.github/funding/COMMERCIAL_POSITIONING.md` where present.

Agents **do not** invent ARR, pilot counts, or signed LOIs.
