...
## 1 September 2026 — Skills and harness update

Coastal Alpine Tech created and updated skills, and updated the private CAT Agent Harness, for NZ-Start-Up and related products.

Public GitHub remains posture-only. This page does not list new procedures, methods, checklists, or prices.

Full skill bodies and commercial-track packs load from the private harness under a written agreement.

Humans still advise, decide, sign, file, send, and pay.

**Related public pages:** [Skills](public/skills.md) · [Harness](public/harness.md) · [Founder OS](public/founder-os.md) · [NZ-Start-Up](https://github.com/fivepanelhat/NZ-Start-Up)
...
- Closed incorporation and started the post-incorporation legitimacy sequence. Agents draft. The founder files.
...
- Opened a **RevOps campaign** run through Grok Bot / Aether Summit. Nothing is sent, filed, or invoiced by a bot.
...
*Earlier entries remain on git history. Coastal Alpine Tech Limited — Pre-seed | Taranaki, Aotearoa New Zealand*
