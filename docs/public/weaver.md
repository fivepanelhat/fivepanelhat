...
Weaver is the on-edge orchestrator for tenant-isolated helpdesk and operations queries: intake, fulfilment, and resolution under human-governed routing, with no cross-tenant bleed.

## Safe NZ AI sentence

Coastal Alpine Tech is a Safe NZ AI business: Weaver keeps each tenant’s operational knowledge on the node and under human-governed routing.

## Public posture

- Local-first; personal and tenant data stay purpose-limited.
- Fulfilment can draft; actuation and external send remain gated.
