...
3. **Pilot Alignment Evidence**: For first paid pilots, produce evidence pack mapping stack controls to Framework/Charter/Privacy Act (HITL logs, audit trails, cultural review records).
...
**This alignment positions Coastal Alpine Tech as a trusted sovereign AI Infrastructure partner for Aotearoa — ready for responsible pilots, grants, and collaboration that respects people, whenua, and the frameworks that protect them.**
