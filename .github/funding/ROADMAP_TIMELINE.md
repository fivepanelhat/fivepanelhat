...
| Cultural Advisor | _TBD_ | MDF, MABx, Maori-outcome claims |
...
2027
Q1 Paid pilots x2-3 | NZ seed materials | NZIAT partner push
...
| **P3 Partnership capital** | Oct 2026-ongoing | Maori / whenua (only if real) | MDF, MABx |
...
- [ ] **FD-007** | Bottom-up **SOM v0** spreadsheet (price x farms x seats) | _Due: 2026-08-15_ | Owner: Finance + GTM
...
- [ ] **RD-002** | Confirm entity eligible (company / Maori incorporation path) | _Due: 2026-07-25_
...
### 2.6 CAT-G-002 - Maori Development Fund (P0* | likelihood 48 -> 72 with partnership)
...
### 2.9 CAT-G-009 - Maori Climate Platform (watch only)
