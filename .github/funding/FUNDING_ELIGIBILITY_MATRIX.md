...
Investors and many grant assessors expect **bottom-up** market thinking (customer counts x willingness to pay), not only top-down Gartner slides. Seed-scale VC typically wants a credible path toward large markets (often **$1B+ TAM** framing for venture-scale theses).
...
| **SOM (3-5 yr)** | Paying edge nodes + portal subscriptions for water/soil/biosecurity/cultivation + SDK licenses | Bottom-up: *N* farms x $X/node/year + *M* enterprise seats | **Required for seed narrative** |

### 3.2 Bottom-up SOM sketch (fill numbers before pitch)

```text
SOM = (pilot farms x ARR/farm) + (enterprise seats x ARR/seat) + (SDK OEM deals)
...
| ---: | :--- | :---: | :---: | :--- | ---: |
| 1 | **Legal entity** fit for instrument | [OK] | [OK] | Confirm NZ company / eligible structure | 1 |
| 2 | **Clear problem + technical uncertainty** | [OK] | [OK] (R&D) | Strong offline/sovereign edge thesis | 2 |
| 3 | **Team / domain credibility** | [OK] | [OK] | Fill named leads + advisors | 1 |
| 4 | **Product / prototype evidence** | [OK] | [OK] | Public multi-repo stack | 2 |
| 5 | **Traction** (pilots, LOIs, revenue) | [OK][OK] | medium | Likely weak unless pilots disclosed | 0-1 |
| 6 | **TAM/SAM/SOM + unit economics sketch** | [OK][OK] | medium | Needs bottom-up pack | 1 |
| 7 | **Go-to-market** (who buys, sales motion) | [OK][OK] | low-med | Domain portals defined; sales motion TBD | 1 |
| 8 | **Data / IP / moat story** | [OK] | medium | Architecture + compliance as moat path | 2 |
| 9 | **Regulatory / sovereignty narrative** | niche VC | **high** (NZ public) | Strong CAT differentiator | 2 |
| 10 | **Financial readiness** (books, co-fund, runway) | [OK] | [OK] (co-fund) | Must prepare cashflow packs | 1 |
| 11 | **HITL / governance** for high-risk claims | impact / ESG | **high** | Skills + compliance pack | 2 |
| 12 | **Honest stage labeling** | [OK] | [OK] | No false SOC 2 cert claims | 2 |
...
Likelihood = composite of **fit** (narrative/market) x **readiness** (prerequisites) x **process openness**.
...
| **TPK Maori Development Fund** | Grant / investment | Whenua productivity + Maori outcomes | Regional office first; kaitono entity; ROI evidence | **48** | **72** | Without real Maori-led partnership -> low |
...
* only with authentic Maori partnership pathway
```
...
- Token Maori branding without kaitono consent 
...
**Owner:** Grant lead + Finance | **HITL:** Cultural Advisor for any Maori-outcome claims 
