...
| :--- | :--- | :--- | :--- |
| **Coastal-Alpine-Core** | `curl -fsSL https://raw.githubusercontent.com/fivepanelhat/Coastal-Alpine-Core/main/install.sh \| bash` | `irm https://raw.githubusercontent.com/fivepanelhat/Coastal-Alpine-Core/main/install.ps1 \| iex` | [OK] Win smoke 2026-07-13 |
| **Weaver** | `curl -fsSL .../Weaver/main/install.sh \| bash` | `irm .../Weaver/main/install.ps1 \| iex` | [OK] Win bootstrap |
| **Aether** | `curl -fsSL .../Aether/main/install.sh \| bash` | `irm .../Aether/main/install.ps1 \| iex` | [OK] Win smoke |
