...
def fix_fivepanelhat(text: str) -> str:
    ...
    text = re.sub(
        ...
        + "customary data rights (Te Mana Raraunga / Māori Data Sovereignty) and offline "
...
def soften_overclaims(text: str, repo: str) -> str:
    replacements = [
        ...
        (
            r"The platform is built in partnership with whānau, iwi \(including Muaūpoko\), health professionals, and community organisations\.",
            "The platform is **intended** to be co-designed with whānau, iwi, health professionals, and community organisations as relationships mature (pre-seed — do not treat as formal institutional endorsement).",
        ),
    ]
